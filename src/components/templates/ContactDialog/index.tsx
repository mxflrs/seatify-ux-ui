  ...
  return (
    <dialog className="fixed inset-0 z-[999] flex justify-center items-center bg-transparent backdrop-blur-sm w-full h-full">
      <div className="flex items-center justify-center p-2 sm:p-4 z-50 backdrop-blur-sm relative w-full h-full">
        ...
        h-auto
        relative grid xl:grid-cols-2 grid-cols-1 gap-4
      "
        >
          <button
            className="absolute -top-2 -right-2 text-white text-2xl z-50 h-9 w-9 bg-sfv-gray-400 rounded-full hover:bg-sfv-green-100 cursor-pointer"
            onClick={close}
          ...
          <div
            className="
          flex flex-col bg-image lg:justify-center justify-end items-start text-white p-6 relative w-full
          lg:h-full h-[182px] min-h-[120px]
        "
          >
            <h1 className="text-2xl sm:text-3xl z-10">Content that engages,</h1>
            <p className="z-10 text-lg sm:text-xl pt-1">
              converts, and drives results.
            </p>
            <div className="absolute flex justify-center items-center bg-black opacity-50 h-full w-full inset-0 black-overlay"></div>
          </div>
            ...
            >
              ...
              <div className="flex flex-center justify-center -mt-5 *:text-xs *:text-sf-lila-2">
                <a
                  href="/privacy"
                  target="_blank"
                  className="border-r border-white pr-4 mr-4"
                >
                  Privacy Policy
                </a>
                <a href="https://seatify.io/terms-conditions/" target="_blank">
                  Terms
                </a>
              </div>
